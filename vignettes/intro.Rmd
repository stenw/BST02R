...
At the bottom right panel there is a tab called 'Files' with all files in the working directory and a tab called 'Plots' in which the plots we create will be displayed. In the upper right panel there is also a tab called 'History' in which we can see all commands that recently have been executed. Here you will also find a tab called 'Environment' where all objects we created are listed. 
