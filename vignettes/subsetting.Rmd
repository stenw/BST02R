...
### Making selections based on the position a a vector
...
```{r}
mydata[, 3, drop=FALSE]       # data.frame with a single variabele
```

### Double brackets and the dollar sign
